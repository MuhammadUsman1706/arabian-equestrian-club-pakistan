...
import classes from "./StudCertificates.module.css";
import StudCertificateList from "./StudCertificateElements/StudCertificateList";
...
export default StudCertificate;
