...
import classes from "./LitterInspectionList.module.css";

import {mylitterinspections} from '../../../apis/index';
...
const fetchData=async()=>{
  const response= await mylitterinspections(user?.friendly_url);
...
useEffect(()=>{
    ...
    () => [
      {
        col1: '1',
        col2: 'Usman Baloch',
        col3: 'Brux von Team Panonainsee',
        col4: 'Rita vom Larechs',
        col5: 'Lahore',
        col6: 'Usman Baloch',
        col7: 'May 20, 2015 02:33:48 pm',
        col8: 'Eye Icon'
      },
      {
        col1: '1',
  ...
  return <>
        ...
        <div className={classes["v215_1256"]}>
         ...
         <span className={classes["v215_1299"]}>Litter Inspection List</span>
...
export default LitterInspectionList;
